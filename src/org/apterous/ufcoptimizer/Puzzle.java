...
final class Puzzle {
  ...
  private final ImmutableMap<SummarySkill, RangeConstraint> summarySkillConstraints;
  ...
  public Puzzle(
      ...
      ImmutableMap<SummarySkill, RangeConstraint> summarySkillConstraints,
    ...
    this.summarySkillConstraints = checkNotNull(summarySkillConstraints);
  ...
  public RangeConstraint getSummarySkillConstraint(SummarySkill summarySkill) {
    return summarySkillConstraints.getOrDefault(summarySkill, RangeConstraint.UNCONSTRAINED);
  }
